...
Applies Issue-B and Issue-D formatting fixes to an existing sft_results.csv,producing a new CSV ready for re-evaluation.

  Issue B: multiple \\boxed{} in the post-think section which was merged into one \\boxed{v1, v2, ...}
  Issue D: \\boxed{} only inside <think>, nothing after </think> so the answer rescued into post-think section

Usage

    python apply_bandaid.py
