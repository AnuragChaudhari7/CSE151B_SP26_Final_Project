...
def run_inference(
    ...
    do_eval = "private" in data_path.lower()
    ...
    # Load judger only for private dataset (has ground-truth answers)
    judger = None
    if do_eval:
        print("Private dataset detected — loading Judger for evaluation.")
