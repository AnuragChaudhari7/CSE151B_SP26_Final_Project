...
OUTPUT_PATH = "results/sft_submission_16k_max_token.csv"
GPU_ID      = "0"
...
def main():
    print(f"Loading model and tokenizer from {REPO_PATH}...")
    ...
    sampling_params = SamplingParams(
        max_tokens=16384, #TODO: maybe change to prevent truncation. But in RL make sure it doesn't overtalk for no reason!
        temperature=0.3,
        top_p=0.95,
        top_k=20,
